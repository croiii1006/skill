...
import { ArrowLeft, Download, FileText, AlertTriangle, TrendingUp, Users, Target, Shield, Zap, ChevronRight, ExternalLink, Database, History, X } from 'lucide-react';
...
import { MarketInsightComposer, MOCK_HISTORY, type HistoryEntry } from './MarketInsightComposer';
          ...
          {MOCK_HISTORY.map((entry) => (
            ...
            >
              <div className="flex items-center justify-between mb-1">
                <span className="text-sm font-medium text-foreground">{entry.brandName}</span>
